...
{{< icon name="graduation-cap" pack="fas" >}} Hello, there! I’m Thyago. I’m a molecular biologist who also likes computers, programming and biostatistics! I’m a strong advocate for open(science, data, source), and reproducible research. My main goal is to use biology and computational/statistical tools to understand biological phenomena relevant to human and other living beings. During my graduation I worked mainly with transcriptomics, genomics and molecular biology, both wet and dry benches.
